...
#         # except:
#         #     print("Some issue with", folder_id)
#         #     pass
#         # print(folder_id)
#         # itemList = []
...
#         # The toggle button
#         dbc.Button(
#             DashIconify(icon="bi:arrow-right-circle-fill"),
#             id="btn_sidebar",
#             className="toggle-button",
#             style=TOGGLE_BUTTON_STYLE,
#             n_clicks=0,
#         ),
#         # The vertical "Folder Browser" text
#         html.Div(
#             "Folder Browser",
...
#     if cur_nclick == "SHOW":
#         btn_icon = DashIconify(icon="bi:arrow-left-circle-fill")
#     else:
#         btn_icon = DashIconify(icon="bi:arrow-right-circle-fill")

#     return sidebar_style, content_style, cur_nclick, btn_icon
