...
var ConfigView = View.extend({
    ...
    initialize: function () {
        this.providers = [{
            ...
            hasAuthorizedOrigins: false,
            takesTenantId: false,
            instructions: 'Client IDs and secret keys are managed through the UNA ' +
                'application registration page at https://auth.ncats.nih.gov/. ' +
                'When creating your client ID there, use the following as ' +
